...
const newUser = new NewUser({ name: 'Max', email: 'max@test.com', age: 31 });
...
const newIsSmaller = compare({ first: 3, second: 5, comparator: 'smaller' });
const newIsSmaller2 = compare({ comparator: 'equal', first: 3, second: 5 });